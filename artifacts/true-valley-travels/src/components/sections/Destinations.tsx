...
const destinations = [
  ...
  },
  {
    ...
    desc: "Situated at the confluence of mountain streams from Sheshnag Lake and the Lidder River, Pahalgam is a pristine valley of unspoiled beauty — a gateway to the Betaab and Aru valleys and home to the most scenic trout-fishing routes in India.",
  ...
  },
  {
    id: "doodhpathri",
    name: "Doodhpathri",
    coords: [33.8470, 74.8530] as [number, number],
    distance: "42 km from Srinagar",
    desc: "The 'Valley of Milk' — a sprawling alpine meadow where the Shaliganga river froths so white it is said to look like milk. Far quieter than its famous cousins, it rolls out endless green pastures ringed by dense conifer forest in summer, and turns into a sheet of untouched powder in winter.",
    nearby: ["Shaliganga River", "Tangnar", "Mujpathri"],
    summerImg: "https://images.unsplash.com/photo-1629574499683-6fb13ea10ce9?w=1200&q=80&auto=format&fit=crop",
    winterImg: "https://images.unsplash.com/photo-1707804770720-d151605e5161?w=1200&q=80&auto=format&fit=crop",
    summerTag: "Wildflower Meadows",
    winterTag: "Untouched Powder",
  },
  {
    id: "aru-valley",
    name: "Aru Valley",
    coords: [34.1020, 75.2640] as [number, number],
    distance: "12 km from Pahalgam",
    desc: "A postcard-perfect alpine hamlet on the banks of the Aru river — the launchpad for treks to the Kolahoi Glacier and the Tarsar–Marsar lakes. Pony rides, log huts and grazing meadows make it a serene escape just beyond Pahalgam's bustle.",
    nearby: ["Lidderwat", "Kolahoi Glacier", "Tarsar Lake"],
    summerImg: "https://images.unsplash.com/photo-1643449415972-87d4cfe882a1?w=1200&q=80&auto=format&fit=crop",
    winterImg: "https://images.unsplash.com/photo-1637558929744-024c00b06075?w=1200&q=80&auto=format&fit=crop",
    summerTag: "Trekking Basecamp",
    winterTag: "Snowbound Hamlet",
  },
  {
    id: "betaab-valley",
    name: "Betaab Valley",
    coords: [34.0250, 75.3320] as [number, number],
    distance: "15 km from Pahalgam",
    desc: "Named after the Bollywood film shot here, this lush valley between Pahalgam and Chandanwari is framed by snow-tipped peaks and threaded by the Lidder. Manicured lawns, gurgling streams and a dramatic mountain backdrop make it one of Kashmir's most photographed spots.",
    nearby: ["Chandanwari", "Aru Valley", "Lidder River"],
    summerImg: "https://images.unsplash.com/photo-1646204892016-711ed35535ec?w=1200&q=80&auto=format&fit=crop",
    winterImg: "https://images.unsplash.com/photo-1707762895288-6988d51c2c7f?w=1200&q=80&auto=format&fit=crop",
    summerTag: "Riverside Lawns",
    winterTag: "Snow-Framed Valley",
  },
  {
    id: "gurez-valley",
    name: "Gurez Valley",
    coords: [34.6300, 74.8400] as [number, number],
    distance: "123 km from Srinagar",
    desc: "One of Kashmir's last frontiers — a remote Himalayan valley dominated by the pyramid-shaped Habba Khatoon peak and the roaring Kishanganga river. Wooden Dard-Shin villages, golden meadows and near-total isolation make it the ultimate offbeat journey (best reached May–October).",
    nearby: ["Habba Khatoon Peak", "Kishanganga River", "Tulail Valley"],
    summerImg: "https://images.unsplash.com/photo-1705492558059-5c14787fa5c9?w=1200&q=80&auto=format&fit=crop",
    winterImg: "https://images.unsplash.com/photo-1601231519048-a3a92894d166?w=1200&q=80&auto=format&fit=crop",
    summerTag: "Frontier Wilderness",
    winterTag: "Remote Snowscape",
  },
  {
    id: "sinthan-top",
    name: "Sinthan Top",
    coords: [33.5640, 75.4470] as [number, number],
    distance: "130 km from Srinagar",
    desc: "A breathtaking mountain pass at roughly 3,800 m on the Anantnag–Kishtwar road, where snow lingers even through summer. Panoramic ridgelines, glacial slopes and a swirling sea of clouds reward the long, winding drive — a paradise for snow-lovers and photographers.",
    nearby: ["Daksum", "Margan Top", "Kokernag"],
    summerImg: "https://images.unsplash.com/photo-1621866963889-4fd4803afb8c?w=1200&q=80&auto=format&fit=crop",
    winterImg: "https://images.unsplash.com/photo-1647285302168-eefeed6bdf7f?w=1200&q=80&auto=format&fit=crop",
    summerTag: "Summer Snowfields",
    winterTag: "High-Pass Snow",
  },
  {
    id: "bangus-valley",
    name: "Bangus Valley",
    coords: [34.5200, 74.1700] as [number, number],
    distance: "120 km from Srinagar",
    desc: "A hidden bowl of twin meadows — Bodh (big) and Lokut (small) Bangus — cradled by pine ridges in far-flung Kupwara. Vast grasslands, nomadic Gujjar settlements and absolute silence make this one of Kashmir's least-touched treasures.",
    nearby: ["Lokut Bangus", "Rangwar Forest", "Mawar"],
    summerImg: "https://images.unsplash.com/photo-1622639127144-4433f28299bd?w=1200&q=80&auto=format&fit=crop",
    winterImg: "https://images.unsplash.com/photo-1634376703443-07f4d543581d?w=1200&q=80&auto=format&fit=crop",
    summerTag: "Hidden Meadows",
    winterTag: "Silent Snowfields",
  },
];
